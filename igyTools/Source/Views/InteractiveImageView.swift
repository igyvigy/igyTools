...
//        if allowImageFullscreenPreview { showImageFullscreenOnPVC() }
    }
    
//    func showImageFullscreenOnPVC() {
//        guard let uiImage = self.image else { return }
//        let image = Image(uiImage: uiImage, urlString: urlString)
//
//        let imageSource = ImageSource(images: [image], stringIdentifier: "interactive-image-view-source", id: Spitter.identifier(of: self))
//        let imagesDetailVC = ImagesDetailVC.deploy(with: imageSource, delegate: nil)
//        imagesDetailVC.modalPresentationStyle = .fullScreen
//        heroID = imageSource.imagesIds[0]
//        Spitter.pvc()?.present(imagesDetailVC, animated: true, completion: nil)
//    }
