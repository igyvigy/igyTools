...
public typealias ContentPosition = (horizontal: HorizontalPosition, vertical: VerticalPosition)
public typealias ContentOffset = (horizontal: Double, vertical: Double)
...
public extension UIButton {
    public func setupImageInButton(imagePosition: ContentPosition = (.center, .center),
